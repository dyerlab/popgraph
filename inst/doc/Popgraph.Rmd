...
```{r}
p <- ggplot() + geom_popgraph_edgeset( aes(x=Longitude,y=Latitude), lopho, color="darkgrey" )
p <- p + geom_popgraph_nodeset( aes(x=Longitude, y=Latitude, color=Region, size=size), lopho) 
